...
1. Clone the repository: ```git clone [https://github.com/ola-silicon/Dhwani.git](https://github.com/ola-krutrim/Dhwani)```
2. Install the environment: ```conda create -n dhwani_env python=3.9.17```
3. Activate the environment: ```conda activate dhwani_env```
4. Install the requirements: ```pip install -r requirements.txt```
5. Run CLI: ```python3 cli_inference.py --cfg-path configs/decode_config.yaml``` in A100-SXM-80GB. Now you can input ```wav_path``` and ```prompt```. Enjoy yourself !

### How to infer the model

1. Same as **How to inference in CLI: 1-3**.
2. Running with ```python3 infer.py --cfg-path configs/decode_config.yaml``` in A100-SXM-80GB. 
